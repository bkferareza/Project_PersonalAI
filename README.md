...
4. Trigger the breakpoint, such as by selecting **Open dashboard**, then continue debugging normally.
...
Review adaptive local baselines and anomaly detection.
